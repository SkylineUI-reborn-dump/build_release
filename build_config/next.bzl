...
values = [
    ...
    value("RELEASE_APEX_CONTRIBUTIONS_CONSCRYPT", "conscrypt.prebuilt.contributions"),
    value("RELEASE_APEX_CONTRIBUTIONS_DEVICELOCK", "devicelock.prebuilt.contributions"),
